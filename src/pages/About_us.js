    ...
    <main className="about-us-page">
      <section className="about-us">
        ...
        <h2 className="purpose">
          ...
          empowers <span className="purpose-bolded">black</span>,{" "}
          <span className="purpose-bolded">latinx</span>, and{" "}
          <span className="purpose-bolded">indigenous</span> students with
          technological aspirations through{" "}
          <span className="purpose-bolded">3 pillars:</span>
        </h2>
      </section>
      ...
      <section className="pillar-sections">
        ...
        >
          <p>
            Our wonderful academic chairs work to uphold and facilitate academic
            success by:
          </p>
          <ul>
            <li>
              Creating and overseeing class Slack channels for all CS classes
            </li>
        ...
        >
          <p>
            Outreach, Mentorship, and Social puts all their efforts into
            strengthening our community by
          </p>
          <ul>
            <li>Facilitating our M&M Mentorship Program</li>
            <li>
              Planning and hosting social events like movies, bowling, picnics,
              etc.
            </li>
            <li>
              Hosting general body meetings for peer discussion and bonding
            </li>
            <li>
              Collaborating with clubs like NSBE and SHPE to expand our
              community reach
            </li>
          </ul>
        </PillarSection>
        ...
        >
          <p>
            Our amazing professional development and corporate chairs work to
            promote professional excellence by
          </p>
          <ul>
