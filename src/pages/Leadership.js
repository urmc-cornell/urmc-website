  ...
  componentDidMount() {
    fetch(fullURL)
      ...
      .then((rep) => {
        ...
        // Loop through each row and create eboard cards
        ...
        for (let i = 0; i < activeRows; i++) {
          ...
          // Process Google Drive image URLs
          let headshot_one_id = headshot_one.split("/")[5];
          let headshot_one_url =
            "https://drive.google.com/uc?id=" + headshot_one_id;
          let headshot_two_id = headshot_two.split("/")[5];
          let headshot_two_url =
            "https://drive.google.com/uc?id=" + headshot_two_id;
